...
begin
	# using LinearAlgebra
	result = eigen(c_mat_scale) 

	println("Eigenvalues:", round.(abs.(result.values), digits=4), "\n", 
...
begin
	...
	plot(fig1, fig2, layout=(1,2), size=(900,500))
end

# ╔═╡ 761d2bb2-30c2-470c-99f3-c0258993d765
begin
	bar(ms, sum(abs.(result.vectors[:,1:end-1]), dims=2))
end
...
manifest_format = "2.0"
project_hash = "cca830c5e6d99d9d3b20484c0f260e1b8d17c056"
